      ...
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="text-center max-w-md p-6 bg-white rounded-xl shadow-md border border-gray-200">
          ...
          <p className="mt-2 text-gray-600">
            We couldn't load the transport requests. Please try again later.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-3xl font-bold text-black mb-2">Transport Requests</h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Manage all transportation requests in one place
          </p>
        </motion.div>
        ...
        <div className="mb-4 flex justify-between items-center">
          <p className="text-sm text-gray-600">
            Showing {filteredRequests?.length || 0} of {data?.data?.length || 0} requests
          </p>
        ...
        {filteredRequests?.length > 0 ? (
          ...
          >
            ...
            <h3 className="text-lg font-medium text-black mb-1">No transport requests found</h3>
            <p className="text-gray-500 max-w-md mx-auto">
              {searchTerm || statusFilter !== "all" || serviceFilter !== "all" || dateFilter !== "all"
                ? "No requests match your current filters. Try adjusting your search criteria."
                : "There are currently no transport requests available."}
            </p>
          </motion.div>
        )}
      </div>
